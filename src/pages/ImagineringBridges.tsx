 ...
 const MapCard = () => (
  <div className="bg-white rounded-lg shadow-xl p-0 mb-6 overflow-hidden animate-fade-in hover:scale-105 hover:shadow-2xl hover:ring-2 hover:ring-primary transition-all duration-300 border border-primary/10">
    ...
    <div className="rounded-lg overflow-hidden shadow-md mx-8">
      <iframe
        title="IMAGINEERING BRIDGES INDIA LLP Location"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14761.274446013533!2d77.5547313!3d23.1428784!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c47003f87eb01%3A0x3cb7101ed6988340!2sIMAGINEERING%20BRIDGES%20INDIA%20LLP!5e0!3m2!1sen!2sin!4v1697444775000!5m2!1sen!2sin"
        width="100%"
        height="220"
        loading="lazy"
        allowFullScreen
      ...
      <div className="text-center text-gray-600 text-xs my-3">
        IMAGINEERING BRIDGES INDIA LLP, Industrial Area Bagroda, E45, Bhopal, Madhya Pradesh 462045
      </div>
    </div>
  </div>
);
