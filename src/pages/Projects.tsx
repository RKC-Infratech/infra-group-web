...
const Projects = () => {
  ...
  client: "ARVIND TECHNO INFRA PRIVATE LIMITED"
    ...
    {
  title: "MAJOR BRIDGE ACROSS KUNDALIKA CREEK BETWEEN REVDANDA TO SALAV ON REVAS REDDI COASTAL HIGHWAY",
  firm: "RKC Infratech",
  type: "Design",
  ...
  {
  title: "GAIMUKH TO PAYEGAON LINK BRIDGE PROJECT",
  firm: "RKC Infratech",
  type: "Design",
  ...
  {
  title: "PUNE E2 PROJECT",
  firm: "RKC Infratech",
  type: "Design",
  location: "Pune, Maharashtra",
  year: "2023", // Update if needed
  details: "DESIGN OF ALL THE ENABLING STRUCTURE – CASTING YARD, PRECAST SEGMENT MOULD, PRE-TENSION GIRDER MOULD, PIER SHUTTER, PIER CAP SHUTTER, LAUNCHING GIRDER",
  ...
  details: "DESIGNED – PIER CAP CENTERING (HANGING SYSTEM)",
  ...
  {
  title: "CABLE EXTRADOSED BRIDGE OVER GANGA RIVER AT PRAYAGRAJ",
  firm: "RKC Infratech",
  type: "Design",
  location: "Prayagraj, Uttar Pradesh",
  year: "2023", // Update if different
  details: "DESIGNED – LOWER PYLON SHUTTER, UPPER PYLON SHUTTER, PIER TABLE SHUTTER, PONTOONS, LOAD OUT JETTY, STRONG BACK",
  ...
  client: "GPT INFRAPROJECTS LIMITED"
    ...
    {
  title: "PORT CONNECTIVITY ROAD PROJECT",
  firm: "RKC Infratech",
  type: "Design",
  location: "Andhra Pradesh",
  year: "2023", // Update if different
  details: "DESIGNED – LAUNCHING TRUSS FOR ERECTION OF PRECAST UHPC GIRDER",
...
},
{
  ...
  year: "2023", // Update if different
  details: "DESIGNED – PRE-TENSIONING YARD FOR PI GIRDER, DESIGN AND MODIFICATION DRAWING OF EXISTING LAUNCHER",
...
{
  title: "BANDRA – VERSOVA SEA LINK",
  firm: "RKC Infratech",
  type: "Design",
  location: "Mumbai, Maharashtra",
  year: "2023", // Update if needed
  details: "DESIGNED – PILE CAP SHUTTERING ARRANGEMENT WITH SACRIFICIAL SLAB AT BOTTOM",
...
{
  title: "PMT BRIDGE CHANDRA BR-II OVER CHANDRA UNDER ROHTANG TUNNEL PROJECT",
  firm: "RKC Infratech",
  type: "Design",
  location: "Himachal Pradesh",
  year: "2023", // Update if needed
  details: "DESIGNED – FORMWORK TRAVELER",
...
{
  title: "SURAT METRO PROJECT",
  firm: "RKC Infratech",
  type: "Design",
  location: "Surat, Gujarat",
  year: "2023", // Update if different
  details: "DESIGNED – PIER, PIER CAP SHUTTER, CASTING YARD, SEGMENT MOULD, GROUND SUPPORT SYSTEM (LG), LAUNCHING GIRDER, PARAPET LAUNCHER, MODIFICATION & DESIGN OF LAUNCHING GIRDER USED BY CLIENT AT HIGHWAY PROJECT",
  image: "/lovable-uploads/SURAT METRO PROJECT.jpg", // Replace with actual image path if available
  client: "DILIP BUILDCON LIMITED"
},
{
  title: "CABLE EXTRA-DOSED BRIDGE OVER SHARAVATHI BACK WATER",
  firm: "RKC Infratech",
  type: "Design",
  location: "Sagar, Karnataka",
  year: "2023", // Update if needed
  details: "DESIGNED – SACRIFICIAL SLAB FOR PILE CAP SHUTTERING, PIER, PIER CAP, PIER TABLE SHUTTER, CASTING YARD, SEGMENT MOULD, LOADOUT JETTY",
...
{
  title: "CABLE EXTRA-DOSED BRIDGE OVER GANGA RIVER",
  firm: "RKC Infratech",
  type: "Design",
  location: "Sahibganj, Jharkhand",
  year: "2023", // Update if needed
  details: "DESIGNED – WELL, PIER, PIER CAP, PIER TABLE SHUTTER, CASTING YARD, SEGMENT MOULD (SHORT LINE), LAUNCHING GIRDER, LOAD OUT JETTY, PIER & PIER CAP CENTERING, LOWER AND UPPER PYLON SHUTTERING",
...
},
{
  ...
  location: "Bhopal, Madhya Pradesh",
  year: "2023", // Update if needed
  details: "DESIGNED – PIER, PIER CAP SHUTTER, CASTING YARD, SEGMENT MOULD, LAUNCHING GIRDER, PARAPET LAUNCHER",
  image: "/lovable-uploads/BHOPAL METRO.jpg", // Replace with actual image path if available
  client: "DILIP BUILDCON LIMITED"
},
{
  title: "INDORE METRO PROJECT",
  firm: "RKC Infratech",
  type: "Design",
  location: "Indore, Madhya Pradesh",
  year: "2023", // Update if different
  details: "DESIGNED – PIER, PIER CAP SHUTTER, CASTING YARD, SEGMENT MOULD, LAUNCHING GIRDER, PARAPET LAUNCHER, MODIFICATION & DESIGN OF LAUNCHING GIRDER USED BY CLIENT AT HIGHWAY PROJECT",
  image: "/lovable-uploads/INDORE METRO PROJECT.jpg", // Replace with actual image path if available
  client: "DILIP BUILDCON LIMITED"
},
{
  title: "BALANCE CANTILEVER BRIDGE",
  firm: "RKC Infratech",
  type: "Design",
